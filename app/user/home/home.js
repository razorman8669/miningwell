    ...
    function ticker() {
        dataService.getData("/pool/chart/hashrate/pplns", function(data){
            ...
            data = _.forEach(data, function(element) {
                ...
                element.hs = element.hs/1000; // KH/s
                // element.hs = element.hs/1000000; // MH/s
            });
...
//                            type: "date"
    ...
    timerService.register(ticker2, 'poolEffortChart');
    ticker2();

    // timerService.register(ticker3, 'poolMinersChart');
    // ticker3();
